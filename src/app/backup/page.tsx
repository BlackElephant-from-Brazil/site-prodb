...
export const metadata: Metadata = {
  ...
  description:
    'Backup em nuvem empresarial com RPO e RTO definidos em contrato. Planos a partir de R$ 99/mês. Teste grátis de 15 dias no plano Avançado. ISO 27001, LGPD-ready.',
}
...
const howItWorks = [
  {
    ...
    description:
      'O Online Backup Manager (OBM) é instalado nos servidores ou estações que você quer proteger. Configuração em menos de 15 minutos.',
  },
  {
    step: '02',
    title: 'Configure o agendamento',
    description:
      'Defina quais pastas, bancos de dados ou sistemas serão incluídos, e a frequência. Backup diário é o padrão; intervalos menores disponíveis nos planos avançados.',
  },
  {
    step: '03',
    title: 'Execute simulações de restauração',
    description:
      'Backup sem teste de restauração é promessa, não proteção. Nossa equipe acompanha os primeiros testes e estabelece os RTOs reais do seu ambiente.',
  },
]
...
const faqs = [
  {
    ...
    a: 'O RPO padrão é de 24 horas (backup diário). O RTO depende do volume de dados e do tipo de restauração — arquivo único, pasta ou sistema completo. Nos planos Sob Medida, RPO e RTO são definidos em contrato.',
  },
  {
  ...
  },
  {
    ...
    a: 'O OBM é o agente de backup instalado nos seus servidores ou estações. Ele gerencia a compressão, criptografia e transmissão incremental dos dados até a nuvem ProDB.',
  },
  {
    ...
    <MarketingLayout>
      ...
      <section className="bg-navy-900 text-white py-20 md:py-32 relative overflow-hidden">
        <div
          ...
          style={{ background: 'radial-gradient(ellipse at 30% 60%, #22D3EE 0%, transparent 50%)' }}
        />
        <div className="relative mx-auto max-w-[1184px] px-4 md:px-6 xl:px-8">
          <div className="max-w-3xl">
            ...
            <h1 className="mb-5 text-4xl font-bold leading-tight tracking-tight md:text-5xl text-balance">
              ...
              <span className="text-cyan-400">restauração garantida</span>
            </h1>
            <p className="mb-8 text-lg text-slate-300 leading-relaxed max-w-2xl">
              Backup em nuvem com RPO e RTO definidos em contrato. Planos em reais, a partir de
              R$ 99/mês. Teste grátis de 15 dias no plano Avançado — sem cartão de crédito.
            </p>
      ...
      {/* How it works */}
      <section id="como-funciona" className="bg-slate-50 py-16 md:py-20">
      ...
      {/* Feature matrix */}
      <section className="bg-slate-50 py-16 md:py-20 overflow-x-auto">
        <div className="mx-auto max-w-[1184px] px-4 md:px-6 xl:px-8">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-slate-200 bg-slate-50">
                  ...
                  <th className="py-4 px-4 text-center font-semibold text-cyan-600">Avançado</th>
                    ...
                    {(['essencial', 'avancado', 'sobMedida'] as const).map(plan => (
                      <td key={plan} className="py-3 px-4 text-center">
                        {typeof row[plan] === 'boolean' ? (
                          ...
                          <span className={plan === 'avancado' ? 'text-cyan-700 font-medium' : 'text-slate-700'}>
                            {row[plan] as string}
                          </span>
                        )}
                      </td>
      ...
      <CTABandSection
        ...
        subheading="Ative agora o plano Avançado e veja seu backup funcionando hoje."
